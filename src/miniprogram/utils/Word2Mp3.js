...
var es6_promise_min_1 = require("./es6-promise.min");
...
var Word2Mp3 = (function () {
    ...
    Word2Mp3.prototype.getMp3FilePath = function (word, downloadSuccess) {
        var _this = this;
        var that = this;
        var promise = new es6_promise_min_1.Promise(function (resolve, reject) {
            wx.downloadFile({
